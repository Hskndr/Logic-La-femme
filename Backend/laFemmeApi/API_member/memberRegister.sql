...
INSERT INTO `memberRegister` (`p_id`, `p_name`, `p_email`, `p_password`,`p_typeRelation`,`p_invitationCode`,`p_country`, `p_state`,`p_postalZipCode`,`p_dateOfBirth`,`p_age`,`p_zodiacSign`,`p_raceEthnic`,`p_lookingFor`) VALUES
